            ...
            <div class="exchange-market add-float" v-if="exchangeItem">
              <div class="wrap-addition">
                ...
                <div class="option-detail">
                  ...
                  <div class="wrap-option" v-if="exchangeItem.item.addOptions && exchangeItem.item.addOptions.length > 0">
              ...
              <div class="wrap-suggest" v-if="suggestedTradeItems.filter((item) => item.tradeUID != exchangeItem.tradeUID).length > 0">
                ...
                <div class="suggest-list" v-if="!exchangeItem.item.uniqueNo">
                  <ul class="list">
                    <router-link
                      tag="li"
...
import { useBack, useFormattedRefNumber } from '@/composables/common';
...
export default defineComponent({
  ...
  setup(props, { root }) {
    ...
    const { usd, formattedUsd } = useHydraToUsd(exchangeItem, 'price');
    ...
    const openTrade = () => {
      ...
      //   setCommonModal({
      //     open: true,
      //     title: i18n.t('t.common.mir4.account'),
      //     desc: i18n.t('s.common.mir4.account'),
      //     primary: 'OK',
      //   });
      //   return;
      // }
