        ...
        <div class="wrap-grid">
          <div class="grid-timeline">
            <div class="exd-ranking exchange-list">
              <v-tabs :value="selectedTab" @change="setSelectedTab" class="tab-rounds" background-color="transparent">
...
import { defineComponent, onMounted, onUnmounted, reactive, ref, toRefs, watch, computed } from '@vue/composition-api';
...
export default defineComponent({
  ...
  components: { ItemCard, ItemSeller, ItemInfo, BackButton, TopTradedItem, Footer, AccountInfo, SidebarContactUs, ListFilter, ListUniqueFilter },
  setup(props, { root }) {
    const card = ref(null);
