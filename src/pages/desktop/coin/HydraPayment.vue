      ...
      <section class="section section1">
        <div class="section__inner">
          <h2 class="section-title">
            <!-- <span v-html="$t('w.hydra-payment.payment')"></span> -->
            <span>HYDRA PAYMENT</span>
          </h2>
          <!-- <strong class="sub-title" v-html="$t('t.hydra-payment.section1.title2')"></strong>
          <p class="desc" v-html="$t('s.hydra-payment.section1.desc1')"></p>
          <p class="desc" v-html="$t('s.hydra-payment.section1.desc2')"></p> -->
          ...
          <div class="wrap-exchange-rate-card">
            <exchange-rate-card :exchangeValue="oracleValue" :oracle="oracle" />
            <!-- <p class="caution" v-html="$t('s.hydra-payment.section1.caution1')"></p> -->
      ...
      <section class="section section2">
        <div class="section__inner">
          <div class="tab-header">
            <!-- <h3 class="section-title" v-html="$t('t.hydra-payment.section2.title1')"></h3> -->
            <h3 class="section-title">HYDRA Payment Illustration</h3>
            <v-tabs class="toggle-currency" v-model="tabPaymentProduct" hide-slider background-color="transparent">
            ...
            <v-tab-item>
              <div class="grid-product">
                ...
                <div class="grid-item">
                  ...
                  <div class="btn-payment">
                    <img src="~@/assets/img/desktop/hydra-payment/logo-hydra-gold.webp" width="28" alt="HYDRA" />
                    <span class="price">{{ 9.99 | hydra(oracle) }}</span>
                  </div>
                </div>
                <div class="grid-item">
...
import HydraYoutubeVideo from '@/components/coin/desktop/hydra/HydraYoutubeVideo';
...
@import '~@/assets/sass/desktop/pages/coin/hydra-payment';
</style>
