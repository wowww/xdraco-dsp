            ...
            <div class="description">
              ...
              <dl>
                ...
                <dd>
                  ...
                  <p class="desc-info" v-show="false">{{ $t('s.intro-trinity.algorithm3') }}</p>
              ...
              <div class="between-wrap">
                <div>
                  ...
                  <router-link to="/hydra" class="link-type1 link">{{ $t('w.draco.coins.more') }}</router-link>
                </div>
    ...
    <section class="section guide-draco">
      <div class="section__inner smeltery">
        ...
        <div class="derby-wrap">
          ...
          <div class="derby__date" v-if="derby && Array.isArray(derby) && derby.length > 0" :set="(today = derby[derby.length - 1])">
            {{ $t('s.smelting-cost.updated2') }}
          </div>
        </div>
    ...
    <section id="guideStep" class="section guide-draco">
      <div class="section__inner no-gutter">
        <div>
          ...
          <div class="divide-half" v-viewer="viewerOption">
            <div class="area">
...
@import '~@/assets/sass/components/derby';
@import '~@/assets/sass/desktop/pages/coin/draco';
</style>
