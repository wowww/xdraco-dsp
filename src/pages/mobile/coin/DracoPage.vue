  ...
  <div class="intro-draco">
    ...
    <section class="section">
      ...
      <div class="derby no-gutter">
        ...
        <div class="derby__date" v-if="derby && Array.isArray(derby) && derby.length > 0">{{ $t('s.smelting-cost.updated2') }}</div>
      </div>
    ...
    <section id="guideStep" class="section guide-draco mt-64">
      <div class="description" v-viewer="viewerOption">
...
@import '~@/assets/sass/mobile/pages/coin/draco';
</style>
