      ...
      <div class="section__inner">
        <div class="exchange-list for-list">
          ...
          <div id="wrapFilterList" class="wrap-swiper sticky">
            <swiper ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions" v-if="filter.searchType === 1">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
              <swiper-slide key="ex-list-filter-class">
                <list-filter
                  :disabled="filter.searchType !== 1"
              ...
              <swiper-slide key="ex-list-filter-item-type">
                <list-filter
                  :disabled="filter.searchType !== 1"
              ...
              <swiper-slide key="ex-list-filter-grade">
                <list-filter
              ...
              <swiper-slide key="ex-list-filter-tier">
                <list-filter
                  :disabled="filter.searchType !== 1"
              ...
              <swiper-slide key="ex-list-filter-enhance">
                <list-filter
                  :disabled="filter.searchType !== 1"
            ...
            <swiper ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions" v-if="filter.searchType === 2">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
              <swiper-slide key="ex-list-filter-grade">
            ...
            <swiper ref="swiperFilter" class="wrap-filter" :options="swiperFilterOptions" v-if="filter.searchType === 3">
              <swiper-slide>
                <list-unique-filter />
              </swiper-slide>
              <swiper-slide key="ex-list-filter-grade">
          ...
          <div v-if="loading" style="display: flex; flex-direction: column; padding: 10rem 5rem; justify-content: center; align-items: center">
