    ...
    <section class="section">
      <div class="section__inner">
        ...
        <div class="exd-ranking-list" v-if="selectedTab === 0" style="margin-top: 24px">
          ...
          <div class="wrap-button" v-if="topTradedPage * 10 < topTradedItems.length && topTradedPage < 10">
...
export default defineComponent({
  ...
  components: { ItemCard, ItemInfo, TopTradedItem, Footer, AccountInfo, ListFilter, Swiper, SwiperSlide },
