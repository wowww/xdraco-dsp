      ...
      <div class="hsp-info">
        <div class="item">
          <dl class="define-value">
            ...
            <dd v-if="!isPreStake">
              <div>
                <p class="date">Reward HYDRA minting will begin on Jan. 28th, 2022 00:00 UTC+8</p>
              </div>
            </dd>
            <dd v-else>
              <div>
            ...
            <div class="currency-volume">
              <span class="volume wemix">9,999,999<span class="decimal-point">.9999</span></span>
              <!-- <span class="volume dollar">9,999,999<span class="decimal-point">.9999</span></span> -->
            </div>
            <v-divider />
            <div class="graph-wrap">
              <em class="percent">17.32%</em>
              <div class="graph"><span class="bar" style="width: 17.32%"></span></div>
            </div>
          </dl>
        </div>
