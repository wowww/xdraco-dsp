  ...
  <main class="contents">
    <section class="section">
      <div class="section__inner">
        ...
        <!-- 구매하기 팝업  -->
        <v-dialog content-class="dialog-item-buy dialog-stake2 theme-dark" v-model="dialogBuyItem" max-width="640" persistent fullscreen>
          <template v-slot:activator="{ on, attrs }">
            <button type="button" v-bind="attrs" v-on="on" style="display: block; color: #fff; font-weight: bold">[Popup - Buy Item]</button>
          </template>
          <div class="content">
            ...
            <div class="item-content">
              <div class="wrap-central">
                <div class="wrap-charinfo">
                  <CharInfo character="warrior" name="dracoqueen" server="ASIA 220"></CharInfo>
        ...
        <!-- 구매하기 팝업(신형) -->
        <v-dialog content-class="dialog-item-buy bg-point" v-model="dialogBuyItemN" max-width="640" persistent fullscreen>
          <template v-slot:activator="{ on, attrs }">
        ...
        <!-- 구매하기 팝업  -->
        <v-dialog content-class="dialog-item-regi theme-dark" v-model="dialogRegiItem" max-width="640" persistent fullscreen>
          <template v-slot:activator="{ on, attrs }">
          ...
          <div class="content">
            ...
            <div class="item-content">
              <div class="wrap-cardinfo">
                ...
                <div class="item-detail">
                  <ItemManual itemName="Shineworld Dragon Gloves2" showType="normal" :rankType="rankType" desc="none"></ItemManual>
                  <!-- <ItemManual
                    itemName="Shineworld Dragon Gloves2"
                    showType="normal"
                    :rankType="rankType"
                    desc="none"
                    snCode="Serial NO.#12345678"
                  ></ItemManual> -->
