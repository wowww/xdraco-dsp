  ...
  <main class="contents exd-event">
      ...
      <div class="content">
        ...
        <div class="event-content">
          <div class="wrap-reward">
            <img src="@/assets/img/mobile/promotion/2112-exd/reward-1draco.webp" width="207" alt="REWARD 1DRACO" class="ticket" />
    ...
    <section class="section section1">
      ...
      <div
        ...
        "
      >
        <strong @click="joinedEvent = true" style="color: #fff">[Popup - 신청완료]</strong>
        <strong @click="toogleContentsUI(0)" style="color: #fff">[리워드 기본] - </strong>
        <strong @click="toogleContentsUI(1)" style="color: #fff">[리워드 활성화] - </strong>
        <strong @click="toogleContentsUI(2)" style="color: #fff">[리워드 에러] - </strong>
        <strong @click="toogleContentsUI(3)" style="color: #fff">[리워드 로딩]</strong>
      </div>
      <!-- UI확인용 코드 -->
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-sealing-1.webp" alt="XDRACO Warehouse" /><!-- 다국어도 alt 챙겨주세요. -->
                    </figure>
            ...
            <dl class="define listing">
              ...
              <dd>
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-listing-1.webp" alt="List item" />
                    </figure>
            ...
            <dl class="define selecting">
              ...
              <dd>
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-selecting-1.webp" alt="판매 아이템 상세 정보" />
                    </figure>
              ...
              <dd>
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img
                        src="@/assets/img/mobile/promotion/2112-exd/exd-collecting-1.webp"
                  ...
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-collecting-2.webp" alt="Purchase" />
                    </figure>
            ...
            <dl class="define validating">
              ...
              <dd>
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-validating-1.webp" alt="Purchase validation" />
                    </figure>
            ...
            <dl class="define redeeming">
              ...
              <dd>
                ...
                <div class="wrap-img">
                  <div class="area">
                    <figure class="wrap-image by-viewer">
                      <img src="@/assets/img/mobile/promotion/2112-exd/exd-redeeming-1.webp" alt="In-game mailbox." />
                    </figure>
...
@import '~@/assets/sass/mobile/pages/exd-event2112';
</style>
