<template>
  ...
  <!-- bg-epic -->
  <!-- bg-rare -->
  <main class="contents nft" :class="'market single bg-' + rankType">
    <section class="section">
      <div class="section__inner">
        <div class="subnav-block"></div>
        <div class="function">
          <div>
            <a href="#"><span class="backtolist">Back</span></a>
          </div>
        </div>
              ...
              <div class="wrap-addition">
                <div class="wrap-character-equip">
                  <ul class="list-character-equip">
                    ...
                    <!-- <li class="list-character-equip__item" data-item-grade="uncommon" data-item-type="earring"> -->
                    ...
                    <div class="item-manual">
                      ...
                      <ul class="item-detail-table size-lg">
                        <li class="classname">
                          <span>Arbalist</span>
                          <strong>
                            <img src="@/assets/img/common/ranking/ico_klass_arbalist.webp" width="40" alt="arbalist" />
                            <!-- <img src="@/assets/img/common/ranking/ico_klass_lancer.webp" width="40" alt="lancer" /> -->
                            <!-- <img src="@/assets/img/common/ranking/ico_klass_sorcerer.webp" width="40" alt="sorcerer" /> -->
                            <!-- <img src="@/assets/img/common/ranking/ico_klass_taoist.webp" width="40" alt="taoist" /> -->
                            <!-- <img src="@/assets/img/common/ranking/ico_klass_warrior.webp" width="40" alt="warrior" /> -->
                          </strong>
                        </li>
                        <li class="level">
                          <span>Level</span>
    ...
    <div class="float-bottom">
      <div class="sale-item">
        <div data-item-type="grade-5" class="item-info">
          <div class="item__layer">
            <div class="wrap-item">
              <img src="@/assets/img/common/nft-detail/@profile-float.webp" width="56" alt="taoist" class="item" />
            </div>
          </div>
          <div class="item-desc">
            <h4 class="item-name">masterSorcer</h4>
            <p>ASIA112</p>
          </div>
          <div class="item-manual">
            <ul class="item-detail-table size-lg">
              <li class="classname">
                <span>Warrior</span>
                <strong>
                  <!-- <img src="@/assets/img/common/ranking/ico_klass_arbalist.webp" width="28" alt="arbalist" /> -->
                  <!-- <img src="@/assets/img/common/ranking/ico_klass_lancer.webp" width="28" alt="lancer" /> -->
                  <!-- <img src="@/assets/img/common/ranking/ico_klass_sorcerer.webp" width="28" alt="sorcerer" /> -->
                  <!-- <img src="@/assets/img/common/ranking/ico_klass_taoist.webp" width="28" alt="taoist" /> -->
                  <img src="@/assets/img/common/ranking/ico_klass_warrior.webp" width="28" alt="warrior" />
                </strong>
              </li>
              <li class="level">
                <span>Level</span>
        ...
        <div class="wrap-buy">
          <div class="price">
            <strong class="ico-wemixcredit ico-sm add-inside">273,000</strong>
            <span class="rate">$ 1,003</span>
          </div>

          <!-- QR코드 팝업 -->
          <v-dialog content-class="wemix-qr-wrap" v-model="dialogQr" max-width="480" persistent>
            <template v-slot:activator="{ on, attrs }">
...
import Stat from '@/pages-ui/desktop/NftDetail/Stat';
import Skill from '@/pages-ui/desktop/NftDetail/Skill';
import Spirit from '@/pages-ui/desktop/NftDetail/Spirit';
import MagicStone from '@/pages-ui/desktop/NftDetail/MagicStone';
import MysticalPieces from '@/pages-ui/desktop/NftDetail/MysticalPieces';
import MysticalPiecesEmpty from '@/pages-ui/desktop/NftDetail/MysticalPiecesEmpty';
import Conquest from '@/pages-ui/desktop/NftDetail/Conquest';
import Training from '@/pages-ui/desktop/NftDetail/Training';
import Asset from '@/pages-ui/desktop/NftDetail/Asset';
import Codex from '@/pages-ui/desktop/NftDetail/Codex';
import Inventory from '@/pages-ui/desktop/NftDetail/Inventory';
import PriceHistory from '@/pages-ui/desktop/NftDetail/PriceHistory';
