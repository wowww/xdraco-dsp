              ...
              <div class="wrap-addition">
                ...
                <div class="option-detail">
                  <div class="wrap-item-desc">
                    <!-- 모듈로 만들기 -->
                    <ItemManual itemName="Protection Bauble" showType="rankonly" :rankType="rankType"></ItemManual>
                  ...
                  <div class="wrap-fire">
                    <ul class="list">
                      ...
                      <li>
                        ...
                        <p>
                          10% chance to increase <em class="point">Accuracy</em> by <span class="time">70</span> for
                          <span class="time">15sec</span> on attack Cool 15 sec.
                        </p>
                      </li>
                    </ul>
                  </div>
