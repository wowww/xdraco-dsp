          ...
          <div class="grid-timeline">
            ...
            <div class="wrap-my-mirage">
              ...
              <template v-else>
                ...
                <ul class="list-card-nft">
                  <li v-for="item in nftCards" :key="item.id" :aria-disabled="item.disabled">
                    <card-nft :itemGrade="item.grade" characterClass="arbalist" smaller="sm" :isMirage="item.isMirage"></card-nft>
                    <div class="wrap-button">
                      <v-dialog content-class="dialog-mirage dialog-scorepop-type2 dialog-mirage-score" v-model="item.isDialogOpen">
                        ...
                        <div class="content">
                          ...
                          <div class="info">
                            <card-nft :itemGrade="item.grade" characterClass="arbalist" smaller="sm"></card-nft>
                            <div class="info-box">
                              <dl class="info-score">
                                <dt>MIRAGE Score</dt>
                                <dd>
                          ...
                          <div class="mirage-popup-scorepopdesc">
                            ...
                            <p>
                              NFTs transferred to the roster CAN NOT be unsealed for gameplay or registered on NFT Marketplace for sale until they
