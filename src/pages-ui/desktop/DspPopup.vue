  ...
  <main class="contents">
    <section class="section">
      <div class="section__inner">
        <!-- 00_common_로그인팝업  -->
        <v-dialog content-class="dialog-login" v-model="dialogLogIn" max-width="360" persistent>
                        ...
                        <ul class="list">
                          <li>
                            <div class="list-content">
                              <div class="active-info">
                                <div class="thumb">
                                  <img src="@/assets/img/desktop/popup/profile-mirage.webp" width="48" height="48" alt="MIRAGE" />
                                </div>
                                <div class="info">
                          ...
                          <li>
                            <div class="list-content">
                              <div class="active-info">
                                <div class="thumb">
                                  <img src="@/assets/img/desktop/popup/profile-hydra.webp" width="48" height="48" alt="HSP" />
                                </div>
                                <div class="info">
                                  <span class="time">NOW</span>
        ...
        <v-dialog content-class="dialog-account" v-model="dialogAccountnull" max-width="560" persistent>
          <template v-slot:activator="{ on, attrs }">
            <button type="button" v-bind="attrs" v-on="on" class="link-popup">[Show AccountPopup Null]</button>
          </template>
          <div class="content">
                    ...
                    <div class="tabs-content">
                      <div class="msgbox vcenter">
                        <div>
                          ...
                          <div class="desc">
                            XDRACO의 모든 서비스를 사용하기 위해서는 WEMIX WALLET 연결이 반드시 <br />
                            필요합니다. MIR4를 실행하고 WEMIX WALLET과 연결하세요.
                          </div>
                          <div class="wrap-button">
        ...
        <!-- Lv40이상 케이스  -->
        <v-dialog content-class="dialog-account" v-model="dialogAccount40" max-width="560" persistent>
          <template v-slot:activator="{ on, attrs }">
        ...
        <v-dialog content-class="dialog-common" v-model="dialogCommon" max-width="480" persistent>
          ...
          <div class="content">
            ...
            <div class="wrap-notice">
              <div class="msgbox vcenter">
                <div>
                  <h4 class="title">Title 2line text Lorem ipsum dolor sit amet,<br />consectetur adipiscing elit.</h4>
                  <div class="desc">
        ...
        <!-- ### Stake Earlier.###  -->
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundStakeEalier" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
        ...
        <!-- ### Stake MORE.###  -->
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundStakeMore" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
        ...
        <!-- ### Stake MORE ERROR.###  -->
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundStakeError" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
          ...
          <div class="content">
            ...
            <div class="card-content">
              ...
              <div class="form-amount">
                <span class="desc alert">less than previous stake DRACO + minimum stake DRACO</span>
                <div class="wrap-form">
                  <div class="fieldset editable alert">
                    <div>
                      <span class="ico-darco ico-xs"><em class="hidden">DRACO</em></span>
                      <!-- <span contenteditable="true" placeholder="Stake Amount"></span> -->
                      <input type="text" placeholder="Stake Amount" value="3000" />
                    </div>
                    <div class="in-msg">
                      <span>Previous Stake</span>
                      <span class="ico-darco ico-xs add-inside">3,000</span>
        ...
        <!-- ### Pre-Stake ###  -->
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundPreStake" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
        ...
        <!-- ### Pre-Stake MORE ###  -->
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundPreStakeMore" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
                ...
                <div class="wrap-form">
                  <div class="fieldset editable">
                    <div>
                      <span class="ico-darco ico-xs"><em class="hidden">DRACO</em></span>
                      <!-- <span contenteditable="true" placeholder="Stake Amount"></span> -->
                      <input type="text" placeholder="Stake Amount" value="3100" />
                    </div>
                    <div class="in-msg">
                      <span>Previous Stake</span>
                      <span class="ico-darco ico-xs add-inside">3,000</span>
        ...
        <!-- ### Pre-Stake MORE ###  -->
        <v-dialog content-class="dialog-stake theme-dark winner" v-model="dialogRoundReward" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
            ...
            <div class="card-content">
                ...
                <div class="char-detail">
                  <div class="wrap-detail">
                    ...
                    <div class="detail-card">
                      ...
                      <!-- <img
                          src="@/assets/img/desktop/temp/dummy-card.png"
                          width="240"
                          height="344"
                          alt="카드 더미 이미지 추후 공용컴포넌트로 교체예정"
                        /> -->
                    </div>
                  </div>
                </div>
              ...
              <div class="wrap-button">
                <button type="button" class="btn btn-secondary">
                  WIN PRIZE!<br />
                  <span>Redemptionable period expires on November 16, 2022. 00:00 UTC.</span>
                </button>
              </div>
            </div>
          </div>
        ...
        <v-dialog content-class="dialog-stake theme-dark winner" v-model="dialogRoundCharChoice" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
            <button type="button" v-bind="attrs" v-on="on" class="link-popup">[Popup - Reward Winner - 캐릭터선택(11/04)]</button>
          </template>
              ...
              <div class="wrap-char">
                <div class="char-choice">
                  <div class="wrap-detail">
                    ...
                    <div class="detail-desc">
                      당신은 Round 56의 리워드 아이템을 받게 되었습니다.<br />
                      리워드 아이템은 Round 56에 스테이크한 DRACO와 교환됩니다.
                    </div>
                    <div class="detail-card">
                      <Card itemType="legendary"></Card>
                    </div>
        ...
        <v-dialog content-class="dialog-stake theme-dark" v-model="dialogRoundCharChoicelist" max-width="640" persistent>
          <template v-slot:activator="{ on, attrs }">
            <button type="button" v-bind="attrs" v-on="on" class="link-popup">[Popup - Reward Winner - 캐릭터선택 리스트(11/04)]</button>
          </template>
                ...
                <div class="list-header">
                  <div class="server-select">
                    <v-select
                      ...
                      outlined
                      dense
                      :menu-props="{ bottom: true, offsetY: true, contentClass: 'select-menu-dark select-stake' }"
                    ></v-select>
                  </div>
                  <div class="server-update">
                    <button type="button" class="btn-update">
        ...
        <div class="dialog-stake" style="max-width: 560px">
          <div class="fieldset editable">
            <div>
              <span class="ico-darco ico-xs"><em class="hidden">DRACO</em></span>
              <!-- <span contenteditable="true" placeholder="Stake Amount"></span> -->
          ...
          <div class="fieldset editable focus">
            <div>
              <span class="ico-darco ico-xs"><em class="hidden">DRACO</em></span>
              <!-- <span contenteditable="true" placeholder="Stake Amount">10</span> -->
              <input type="text" placeholder="Stake Amount" value="10" />
            </div>
            <div class="add-draco">
              <em class="add">+</em>
...
import RoundNumber from '@/components-ui/desktop/RoundNumber';
import RoundTitle from '@/components-ui/desktop/RoundTitle';
