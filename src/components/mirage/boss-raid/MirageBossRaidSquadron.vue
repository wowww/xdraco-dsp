<template>
  <div class="mirage-my-squadron">
    ...
    <ul class="list-system-noti" v-if="false">
      <li>
        <span class="noti-img">
    ...
    <div class="caution-update" v-if="bossRaidStatus.started && !bossRaidStatus.closed">
    ...
    <ul class="char-list">
      <li v-for="(character, characterIdx) in characterClassList" :key="`mirage-boss-raid-squad-${characterIdx}`">
        <mirage-character :character="character" :key="`mirage-boss-raid-squad-${characterIdx}-char`">
...
import MirageBossRaidCharacter from '@/components/mirage/boss-raid/MirageBossRaidCharacter';
