<template>
  <div class="mirage-latest-raid-result" v-if="beforeSchedule">
    <div class="section-title-bar">
      <h2 class="section-title">Latest Raid Result</h2>
      <span class="raid-date" v-if="isMobile">{{ beforeSchedule && beforeSchedule.EndDT | dateFormat }}</span>
    </div>
    ...
    <div class="caution-update mt-1 pa-10" v-if="mirageLock">
      <p class="caution-txt">{{ t('s.mirage.lock-up.log') }}</p>
    </div>
    <div class="caution-update mt-1 pa-10" v-else-if="resultItems.length === 0">
