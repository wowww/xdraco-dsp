      ...
      >
        ...
        <div class="col-price">
          ...
          <div class="wrap-price-value">
            ...
            <span class="bid-rank" v-if="Number(item.Ranking) <= 10">
            ...
            <span class="txt-buff" v-if="Number(item.Ranking) <= 10"
              >Loot chance buff
              <em>
        ...
        <template v-else>
          <div class="col-wound" v-if="item.WoundType === '3'">
...
export default defineComponent({
  ...
  setup({ item }, { root }) {
    ...
    //     return;
    //   }
    //   $dracoWebApi.get('/bossraid/result', { params: { scheduleUID: item.ScheduleUID, raidType: item.RaidType } }).then(({ data }) => {
    //     if (data.code === 200) {
