<template>
  <div class="result" :class="{ disabled: closed || (valleyResult && Object.keys(valleyResult.Valley).length === 0) }">
    <div class="result-header" v-if="valleyResult">
      <div class="header-wrap">
        <p class="stand" v-if="!closed || (valleyResult && valleyResult.Rank && valleyResult.Rank.length > 0)">
    ...
    <div class="result-contents" v-if="closed">
    ...
    <template v-else>
      <div class="result-contents" v-if="valleyResult && Object.keys(valleyResult.Valley).length > 0">
        <div class="ra-wrap">
          <dl class="rate">
...
export default defineComponent({
  ...
  setup() {
    ...
    const mintingAmount = computed(() => {
      if (valleyResult.value) {
        let sum = 0;
        _.each(valleyResult.value.Valley, (v) => {
