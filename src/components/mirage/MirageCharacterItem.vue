<template>
  <div class="mirage-character" :data-character-grade="computedGrade.grade">
    ...
    <div class="wrap-info">
      ...
      <div class="mirage-character__damage" v-if="injured" />
    </div>
    <div class="mirage-character__enlisted" v-if="character.State === 1">Enlisted</div>
    ...
    <!--      </dd>-->
    <!--    </dl>-->
    <div class="wrap-button" v-if="!hideAction">
      <button v-if="character.State == 0" type="button" class="btn-mirage btn-primary" @click="openSeal" :disabled="closed">
        <span>Seal</span>
        <span class="volume">
      ...
      <button v-if="character.State == 1" type="button" class="btn-mirage btn-primary" @click="openRetreat" :disabled="closed">
        <span>Retreat</span>
        <span class="volume">
          <img src="@/assets/img/common/mirage-character/ico-energy.webp" width="20" height="20" alt="Energy" />
          <em>20</em>
      ...
      <button v-if="injured" type="button" class="btn-mirage btn-recover" @click="openRecover" :disabled="closed">
        <span>Recover</span>
        <span class="volume">
          <img src="@/assets/img/common/mirage-character/ico-energy.webp" width="20" height="20" alt="Energy" />
          <em>5</em>
      ...
      <button v-if="character.State == -1" type="button" class="btn-mirage btn-reinforce" @click="openEnlist" :disabled="closed">
        <span>{{ assault ? t('w.mirage.assault') : t('w.mirage.enlist') }}</span>
        <span class="volume" v-if="valleyList && valleyType">
          <img src="@/assets/img/common/mirage-character/ico-energy.webp" width="20" height="20" alt="Energy" />
