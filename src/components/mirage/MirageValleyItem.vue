<template>
  <v-expansion-panel class="playnow">
    <v-expansion-panel-header class="playnow-header">
      <div class="top" v-if="stakeInfo && valleyList && stakeInfo.Valley && valleyList">
        <div class="top-left">
      ...
      <div class="bottom" v-if="stakeInfo && stakeInfo.Valley && valleyType && stakeInfo.Valley[valleyType]">
        <dl class="rate">
    ...
    <v-expansion-panel-content class="playnow-content">
      <ul class="char-list" v-if="stakeInfo && valleyList && serverInfo">
        <li>
