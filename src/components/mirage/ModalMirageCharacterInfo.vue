    ...
    <div class="content" v-if="character">
      ...
      <div class="wrap-info-chr">
        ...
        <div class="info-item info-level">
          ...
          <div class="flex-col" v-if="character.Lv">
            <span class="info-title">Level</span>
            <span class="info-value">{{ character.Lv }}</span>
          </div>
        </div>
        <div class="info-item info-hidden-valley" v-if="character.DetailType === '1' || character.DetailType === '2' || character.DetailType === '3'">
          <div class="flex-col">
          ...
          <div class="flex-row info-sub" v-if="character.DetailType === '1' || character.DetailType === '2' || character.DetailType === '3'">
          ...
          <div class="flex-row info-sub" v-if="false">
            <span class="info-title">Septaria Harvest</span>
            <span class="info-value septaria">7</span>
          </div>
        </div>
        <div class="info-item info-boss-raid" v-if="character.DetailType === '11' || character.DetailType === '12'">
          <div class="flex-col">
            <span class="info-title">Enlisted</span>
            <div class="flex-row">
        ...
        <div class="info-item info-damaged" v-if="Number(character.State) > 1 || hasBuff11 || hasBuff12">
          <div class="flex-col" v-if="Number(character.State) > 1">
          ...
          <div class="flex-col" v-if="hasBuff11 || hasBuff12">
            <span class="info-title">Curse</span>
            <div class="flex-row" v-if="hasBuff11">
              ...
              <div class="wrap-info-status">
                ...
                <div class="wrap-countdown" v-if="buff11Remaining">
                  <vue-countdown class="countdown" :time="buff11Remaining" v-slot="{ days, hours, minutes }">
                    {{ days }}d {{ hours }}h {{ minutes }}m
                  </vue-countdown>
                  <!--                  <v-tooltip content-class="mirage-tooltip" attach=".wrap-countdown" top max-width="240">-->
                  <!--                    <template v-slot:activator="{ on, attrs }">-->
            ...
            <div class="flex-row" v-if="hasBuff12">
              ...
              <div class="wrap-info-status">
                ...
                <div class="wrap-countdown" v-if="buff12Remaining">
                  <vue-countdown class="countdown" :time="buff12Remaining" v-slot="{ days, hours, minutes }">
                    {{ days }}d {{ hours }}h {{ minutes }}m
                  </vue-countdown>
                  <!--                  <v-tooltip content-class="mirage-tooltip" attach=".wrap-countdown" top max-width="240">-->
                  <!--                    <template v-slot:activator="{ on, attrs }">-->
          ...
          <div class="flex-row">
            <span class="info-title">
              <template v-if="sealRemaining > 0">
                ...
                <vue-countdown class="countdown" :time="sealRemaining" v-slot="{ days, hours, minutes, seconds }">
