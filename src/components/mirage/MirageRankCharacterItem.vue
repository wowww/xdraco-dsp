<template>
  <div class="mirage-character" :data-character-grade="computedGrade.grade">
    ...
    <div class="wrap-info">
      <div class="wrap-rank">
        <div class="mirage-character__rank" v-if="currentRank > 0">
          <em class="level-rank">{{ currentRank }}</em>
          <span class="change" :class="{ plus: rankChange > 0, minus: rankChange < 0 }" v-if="rankChange > 0">{{ rankChange }}</span>
        </div>
        <div class="mirage-character__rank" v-if="beforeRank > 0">
    ...
    <dl class="mirage-character__bonus" v-if="character.RankBonusAmount">
      <dt>Ranking Bonus</dt>
      <dd>
