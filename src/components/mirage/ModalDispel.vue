  ...
  >
    <div class="content">
      ...
      <div class="critically-info">
        ...
        <dl class="critically-count" v-if="buff">
          <dt>
            <img src="@/assets/img/common/mirage-popup/img-56-scissors.webp" width="56" alt="" v-if="!isMobile && buff.BuffType === '11'" />
            <img src="@/assets/img/common/mirage-popup/img-56-stink.webp" width="56" alt="" v-if="!isMobile && buff.BuffType === '12'" />
            <span
              >Curse of <strong>‘{{ t(`w.mirage.boss-raid.buff-type-${buff ? buff.BuffType : ''}`) }}’</strong></span
            >
          </dt>
          <dd v-if="buffRemaining">
            <vue-countdown class="countdown" :time="buffRemaining" v-slot="{ days, hours, minutes, seconds }">
...
export default defineComponent({
  ...
  setup(props, { root }) {
    ...
    const confirmHeal = () => {
      setCommonModal({
        open: true,
        title: t('t.mirage.message.confirm.dispel'),
        desc: '',
        primary: 'Dispel',
