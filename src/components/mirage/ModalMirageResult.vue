  ...
  >
    <div class="content">
      <div class="dialog-header">
        ...
        <v-btn class="btn-close btn-miragepop-close" @click="setVisibleMyResult(false)" fab plain x-small />
      </div>
      <div class="result-content" v-if="valleyResult && valleyList">
        ...
        <div class="char-wrap" v-if="valleyResult.MyRank && valleyResult.MyRank.length > 0">
