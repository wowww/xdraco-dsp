<template>
  <div class="mirage-dashboard" v-if="accountInfo">
    <dl class="list-dashboard">
      ...
      <div>
        ...
        <dd>
          ...
          >
          <button disabled type="button" class="btn-enhance btn-disabled" v-show="false">Enhance</button>
        </dd>
      </div>
      <div>
...
export default defineComponent({
  ...
  setup(props) {
    const { t } = useI18n();
    const { balance, accessToken } = useState(['balance', 'accessToken']);
