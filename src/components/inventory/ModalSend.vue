  ...
  >
    <div class="content" v-if="item">
      ...
      <div class="card-content">
        <div class="wrap-list">
          <div class="notice" v-if="exist === 1 && (item.CharacterUID === '' || item.CharacterUID === '0')">
          ...
          ></div>
          <div class="list-header" v-if="exist === 1 && (item.CharacterUID === '' || item.CharacterUID === '0')">
          ...
          <div class="iscroll">
            <ul class="list">
              ...
              <template v-else>
                <li class="empty" v-if="exist === 0">
                  <h4 class="title">Create a MIR4 account for full access to XDRACO services</h4>
                </li>
                <li class="empty" v-if="exist === 1 && (characters.length === 0 || characters.filter((item) => item.lv >= 40).length === 0)">
...
export default defineComponent({
  ...
  setup(props, { root, emit }) {
    ...
    const {
      ...
      represent,
      characters,
    } = useAccountState(['active', 'loading', 'exist', 'worldNames', 'selectedWorldName', 'represent', 'characters']);
