<template>
  <div class="logged-in">
    ...
    <div class="wrap-balance" :class="{ 'no-gutter': isMobile }" v-if="balance">
      <dl class="balance">
    ...
    <div class="wrap-copy-code" :class="{ 'no-gutter': isMobile }">
      <button type="button" id="btnCopyCode" class="btn-copy-code" @click="copyToClipboard">
    ...
    <div class="wrap-traded-button">
      <v-dialog content-class="dialog-trade-coin" v-model="dialogTradeCoin" max-width="520" persistent>
        ...
        <div class="content">
          <v-btn class="btn-close" @click="dialogTradeCoin = false" fab plain large>
...
export default defineComponent({
  ...
  setup() {
    ...
    const copyToClipboard = () => {
      ...
      clipboardCopy(userInfo.value.address);
