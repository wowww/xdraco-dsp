<template>
  <div class="collectible-main-banner">
    <div class="collectible-main-banner__inner">
      ...
      <div class="wrap-define" v-if="!isMobile">
      ...
      <swiper ref="swiperBanner" :options="swiperOptions" v-if="isMobile">
        <swiper-slide>
      ...
      <div class="swiper-container">
        <div id="swiperPaginationBanner" class="swiper-pagination" slot="pagination"></div>
      </div>
    </div>
