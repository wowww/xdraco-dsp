<template>
  <div>
    <div id="wrapFilterList" class="wrap-swiper sticky">
      ...
      <!-- Filter for Level -->
      <div class="layer-price-range" v-if="isOpen.level">
      ...
      <!-- Filter for Power -->
      <div class="layer-price-range" v-if="isOpen.power">
        <dl class="filter-status">
          <dt>Power</dt>
          <dd>
            <span>Min</span>
      ...
      <!-- Filter for Price -->
      <div class="layer-price-range" v-if="isOpen.price">
    ...
    <div id="wrapDateOrder" class="wrap-date-order" v-if="variants.includes('order')">
    ...
    <div class="wrap-filter-chip">
      ...
      <div class="btn-filter-reset" v-if="hasFilter" @click="reset.all">
        <span>Reset</span>
