  ...
  >
    <div class="card__inner">
      <div class="card__layer front">
        ...
        <div class="wrap-character" v-if="className && itemGrade">
      ...
      <div id="cardLayerBack" class="card__layer back">
        <div class="back__inner">
          <div class="wrap-property">
            ...
            <dl class="property" v-for="(stat, statIdx) in item.stat" :key="`nft-${item.nftID || item.tokenID}-stat-${statIdx}`">
              <dt>{{ stat.statName }}</dt>
          ...
          <!-- Additional Property -->
          <div class="wrap-property" v-show="false">
            <dl class="property">
